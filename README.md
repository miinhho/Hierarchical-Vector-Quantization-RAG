...
| :--- | :--- | :--- | :--- |
| **L2 (Top)** | Global Search | **Int8** | Extremely fast, broad filtering. Acts as a "low-res thumbnail" to quickly identify relevant clusters. |
| **L1 (Mid)** | Intermediate | **Float16** | Balanced precision for narrowing down candidates. |
...
- **Blurring Effect**: Int8 quantization removes "noise" (fine-grained vector details), forcing the search to focus on the **general direction (topic)** rather than exact keyword matches.
